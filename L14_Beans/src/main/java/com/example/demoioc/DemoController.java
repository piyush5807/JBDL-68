...
//    private Person person = new Person();
    ...
    @Autowired // is to fetch the reference of this object from IOC
     ...
     * private Person person = new Person()
     * 2 objects:
     *   1. Created by you when you use new keyword
     *   2. Created by spring as a shared instance of singleton bean
     */

    /**
     * Autowired ~ new Person()
     */

    private static Logger logger = LoggerFactory.getLogger(DemoController.class);

    DemoController(){
        logger.info("Inside demoController constructor: this = {}, person = {}", this, this.person);
    }
...
//        Person person = new Person(1, "Abhinav");
        logger.info("inside demo, person - {}", person);
        this.person.setId(20);
        this.person.setName("ABC");
        logger.info("inside demo, after updating person - {}", person);
    ...
    /**
     * Creating shared instance of singleton bean 'demoIocApplication'
     * Creating shared instance of singleton bean 'demoController'
     * Creating shared instance of singleton bean 'person'
     * Creating shared instance of singleton bean 'demoController2'
     */
}
